...
// Stopwords for keyword extraction (comprehensive list for news content)
const STOPWORDS = new Set([
    ...
    // Contractions (common in quotes - these are noise)
    'im', 'ive', 'id', 'ill', 'dont', 'didnt', 'doesnt', 'wont', 'wouldnt', 'couldnt',
    'shouldnt', 'cant', 'isnt', 'wasnt', 'arent', 'werent', 'hasnt', 'havent', 'hadnt',
    'thats', 'theres', 'heres', 'whats', 'whos', 'lets', 'youre', 'theyre',
    'hes', 'shes', 'youve', 'theyve', 'weve', 'youll', 'theyll', 'well',
    'gonna', 'wanna', 'gotta', 'kinda', 'sorta',

    // Common verbs that appear as noise in articles
    ...
    // Generic adjectives often noise in news
    'good', 'great', 'best', 'better', 'bad', 'worse', 'worst',
    'big', 'large', 'small', 'little', 'long', 'short', 'high', 'low',
    'old', 'young', 'early', 'late', 'hard', 'easy', 'full', 'empty',
    'public', 'private', 'local', 'national', 'international', 'global',
    'major', 'minor', 'main', 'key', 'important', 'significant',
    'recent', 'current', 'future', 'past', 'present',
    'least', 'enough', 'certain', 'likely', 'possible', 'available',
    'real', 'true', 'false', 'wrong', 'right', 'clear',
    'whole', 'entire', 'total', 'complete',
    'single', 'double', 'triple', 'multiple',
    'special', 'specific', 'general', 'particular', 'common',
    'strong', 'weak', 'powerful', 'effective',

    // Common news/article words (filter noise)
    'said', 'says', 'told', 'according', 'reported', 'added', 'noted', 'explained',
    'announced', 'confirmed', 'revealed', 'stated', 'mentioned',
    'like', 'new', 'first', 'last', 'next', 'previous', 'former', 'latter',
    'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten',
    'many', 'much', 'several', 'different', 'similar',
    ...
    // News/media noise
    'news', 'article', 'story', 'post', 'read', 'click', 'share', 'comment',
    'video', 'photo', 'image', 'picture', 'source', 'sources',
    'official', 'officials', 'spokesperson',
    'wrote', 'writer',
    'editor', 'editorial', 'opinion',
    'update', 'updated', 'breaking',
    'coverage', 'covering', 'covered',

    // Generic nouns that are rarely meaningful keywords  
    'area', 'areas', 'place', 'places', 'side', 'sides',
    'kind', 'type', 'types', 'form', 'forms',
    'level', 'levels', 'issue', 'issues', 'matter', 'matters',
    'result', 'results', 'reason', 'reasons', 'example', 'examples',
    'question', 'questions', 'answer', 'answers',
    'change', 'changes', 'problem', 'problems',
    'state', 'states', 'member', 'members', 'head', 'heads',
    'cost', 'costs', 'price', 'prices', 'value', 'values',
    'line', 'lines', 'word', 'words', 'name', 'names',
    'hand', 'hands', 'home', 'homes', 'office', 'offices',
    'power', 'powers', 'force', 'forces',
    'order', 'orders', 'control', 'support',
    'end', 'ends', 'term', 'terms',

    // Possessive forms with apostrophes (normalized)
    'yahoos', 'finace', 'finances', 'jennifer', 'schonberger',
]);
